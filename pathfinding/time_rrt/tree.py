...
class Tree:
    ...
    def check_obstacle(self, point1, point2):
        ...
        print(point1, point2, shift_vector)
            ...
            if reached:
                if not have_parent:
                    ...
                    if dist + self.graph[self.node_num - 1][2] < neighbour_dist_to_orig:
                        if neighbour_parent and neighbour_id in self.graph[neighbour_parent][1]:
                            ...
                            self.rebalance(neighbour_id,
                                           self.graph[neighbour_id][2] - dist - self.graph[self.node_num - 1][2])
